...
public class StaggeredGridView extends ExtendableListView {
  ...
  /**
   * A key-value collection where the key is the position and the {@link GridItemRecord} with some
   * info about that position
  ...
  protected void onLayoutChild(final View child,
    ...
    if (isHeaderOrFooter(position)) {
      layoutGridHeaderFooter(child, position, flowDown, childrenLeft, childTop, childRight,
          childBottom);
    }
    else {

...
public class ViewPagerExampleActivity extends Activity {
   ...
   * Step 3: ExtendedViewPager is a custom view and must be referred to by its full package name in
   * XML
  ...
  static class TouchImageAdapter extends PagerAdapter {
    ...
    private static int[] images = { R.drawable.nature_1, R.drawable.nature_2, R.drawable.nature_3,
        R.drawable.nature_4, R.drawable.nature_5 };
